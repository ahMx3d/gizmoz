...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used during brands for various
    ...
    */
    ...
    'edit_old'      => ucfirst('edit brand'),
    'show_old'      => ucfirst('show brand'),
    ############################# END BREADCRUMB ##########################
    ...
    'td_img_alt'    => ucfirst('brand image'),
    ...
    'brand_details'      => ucfirst('details'),
    ############################# END BRANDS FORM LAYOUT ##########################

    ############################# START BRAND FORM LABELS ########################
    'brand_name'  => ucfirst('name'),
    'brand_stat'  => ucfirst('status'),
    'brand_imag'  => ucfirst('image'),
