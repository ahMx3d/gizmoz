...
return [
    ...
    */
    ...
    'different' => 'هذا الحقل يجب أن يكون مختلفًا في القيمه',
    ...
    'exists' => 'القيمه المختاره غير صالحه',
    ...
    'mimes' => 'يجب أن يكون هذا الحقل ملفًا ينتهي بإحدى هذه الامتدادات: :values',
    'mimetypes' => 'يجب أن يكون هذا الحقل ملفًا ينتهي بإحدى هذه الامتدادات: :values',
    'min' => [
