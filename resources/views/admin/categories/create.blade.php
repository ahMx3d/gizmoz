...
@section('title', __("admin/cates.create_title"))
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    @if (request('create') == 'sub')
                                    {{-- @if (isset($mainCatesForSub) && $mainCatesForSub->count() > 0) --}}
                                    <h4
                                        class="card-title"
                                        id="basic-layout-form">{{ __('admin/cates.subcate_create_header_title') }}</h4>
                                    @else
                                    <h4
                                        class="card-title"
                                        id="basic-layout-form">{{ __('admin/cates.main_cate_create_header_title') }}</h4>
                                    @endif
