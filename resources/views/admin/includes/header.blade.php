            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="">
                        ...
                        <img class="brand-logo" alt="{{config('app.name')}} admin logo"
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="user-name text-bold-700">
                                {{(LaravelLocalization::getCurrentLocale() == 'ar')? __('admin/header.arabic'): LaravelLocalization::getCurrentLocaleName()}}
                            </span>
                            {{-- </span> --}}
                        </a>
                        <div class="dropdown-menu dropdown-menu-right text-center">
                            ...
                            {{-- </ul> --}}
                            @if (!(last(LaravelLocalization::getSupportedLocales()) == $properties))
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="mr-1">{{__('admin/header.greeting')}} <span
                                    class="user-name text-bold-700">{{auth('admin')->user()->name}}</span></span>
