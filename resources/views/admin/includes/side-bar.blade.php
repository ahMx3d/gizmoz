    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="" data-i18n="nav.dash.ecommerce">عرض كل اللغات</a>
                    </li>
                    <li>
                        <a class="menu-item" href="" data-i18n="nav.dash.crypto">اضافة لغه جديده</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href="">
                    ...
                    <span class="menu-title" data-i18n="nav.dash.main">{{ __('admin/sidebar.cates') }}</span>

                </a>
                <ul class="menu-content">
                    <ul class="menu-content">
                        <li class="active">
                            <a href="#" data-i18n="nav.templates.vert.main"
                                class="menu-item">{{ __('admin/sidebar.add_new') }}</a>

                            <ul class="menu-content">
                                <li>
                                    <a href="{{ route('categories.create'). '?create=main' }}"
                                        data-i18n="nav.templates.vert.classic_menu"
                                        class="menu-item">{{ __('admin/sidebar.main_cate') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('categories.create'). '?create=sub' }}"
                    ...
                    <li class="">
                        <span class="badge badge badge-warning badge-pill float-right mr-2">
                            {{ \App\Repositories\Categories\CategoryRepository::allCatesCount() }}
                        </span>
                        <a class="menu-item" href="{{ route('categories.index') }}"
                            data-i18n="nav.dash.ecommerce">{{ __('admin/sidebar.all_cates') }}</a>
                    </li>
                    <li class="">
                        <span class="badge badge badge-info badge-pill float-right mr-2">
                            {{ \App\Repositories\Categories\CategoryRepository::parentCatesCount() }}
                        </span>
                        <a class="menu-item" href="{{ route('categories.index'). '?type=main' }}"
                            data-i18n="nav.dash.ecommerce">{{ __('admin/sidebar.main_cates') }}</a>

                    </li>
                    <li>
                        <span class="badge badge badge-success badge-pill float-right mr-2">
                            {{ \App\Repositories\Categories\CategoryRepository::childCatesCount() }}
                        </span>
                        <a class="menu-item" href="{{ route('categories.index'). '?type=sub' }}"
                            data-i18n="nav.dash.ecommerce">{{ __('admin/sidebar.subcates') }}</a>
        ...
        <li class="nav-item">
            <a href="">
                ...
                <span
                    class="badge badge badge-warning badge-pill float-right mr-2">{{ \App\Models\Cate::childCate()->count() }}</span>
            </a>
            <ul class="menu-content">
                <li class="active">
                ...
                <li>
                    <a class="menu-item" href="{{ route('subcategories.create') }}"
                        data-i18n="nav.dash.crypto">{{ __('admin/sidebar.add_new') }}</a>
                </li>
            </ul>
        </li> --}}
        ...
        <li class="nav-item">
            ...
            <ul class="menu-content">
                ...
                <li>
                    <a class="menu-item" href="" data-i18n="nav.dash.crypto">أضافة طالب </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul class="menu-content">
                <li class="active">
                    <a class="menu-item" href="" data-i18n="nav.dash.ecommerce">تذاكر الطلاب</a>
                </li>
            </ul>
        </li>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item" {{-- href="../vertical-menu-template" --}}
                                href="{{route('edit.shipping.methods', 'free')}}"
                        ...
                        <li>
                            <a class="menu-item" {{-- href="../vertical-modern-menu-template">Modern Menu</a> --}}
                                ...
                                href="{{route('edit.shipping.methods', 'local')}}">{{__('admin/sidebar.local_pickup')}}</a>
                        </li>
                        <li>
                            <a class="menu-item" {{-- href="../vertical-compact-menu-template" --}}
                                href="{{route('edit.shipping.methods', 'rate')}}"
