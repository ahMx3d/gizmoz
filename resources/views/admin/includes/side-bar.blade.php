              ...
              <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                     ...
                     <li class="nav-item">
                            <a href="">
                                   ...
                                   <span class="menu-title"
                                          data-i18n="nav.dash.main">{{ __('admin/sidebar.cates') }}</span>
                     ...
                     <li class="nav-item">
                            <a href="">
                                   <i class="la la-group"></i>
                                   <span class="menu-title"
                                          data-i18n="nav.dash.main">{{ __('admin/sidebar.main_cates') }}</span>
                                   <span
                     ...
                     <li class="nav-item">
                            <a href="">
                                   <i class="la la-group"></i>
                                   <span class="menu-title"
                                          data-i18n="nav.dash.main">{{ __('admin/sidebar.subcates') }}</span>
                                   <span
                     ...
                     <li class=" nav-item">
                            <a href="#">
                                   ...
                                   <span class="menu-title"
                                          data-i18n="nav.templates.main">{{__('admin/sidebar.settings')}}</span>
                            </a>
                            <ul class="menu-content">
                                   <li>
