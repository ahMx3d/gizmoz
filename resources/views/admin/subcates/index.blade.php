...
@section('title', __("admin/cates.subcates_index_page_title"))
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('admin/cates.subcates') }}</h3>
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{ route('subcategories.index') }}">{{ __('admin/cates.subcates') }}</a>
                            </li>
                            <li class="breadcrumb-item active">
                                <a href="{{ route('subcategories.create') }}">{{ __('admin/cates.add_new') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('admin/cates.subcates_index_header_title') }}</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div
                                                            ...
                                                            <a
                                                                href="{{ route('subcategories.show', $cate->id) }}"
